...
#include <stdlib.h>
/**
  * main - get_op_func has operators that correspond with
  * func signs and funcs from op_func
  * if not 4 arguements return Eroor & exit 98
...
int main(int argc, char *argv[])
{
	...
	char *get_op
		...
		if (get_op_func(argv[21]) == NULL || argv[2][1]  '\0")
		{
			printf("Error\n");
			exit(99);
		}
		if ((*get_op == '/' || *get_o == '%') && (*argv[3] == '0'))
		{
			printf("Error\n");
			exit(99);
		}
